...
export default function ManageAccountPage() {
  ...
  const handleUpdateAccount = async () => {
    try {
      const response = await fetchWithErrorHandling(import.meta.env.VITE_API_URL + "/s/account", {
        method: "PATCH",
        headers: {
  ...
  useEffect(() => {
    ...
    fetchWithErrorHandling(import.meta.env.VITE_API_URL + "/s/verify_credentials", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${session?.token}`,
